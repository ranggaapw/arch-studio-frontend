...
export default function ContactSection() {
  ...
  return (
    <section className="w-full py-20 bg-neutral-900 text-white" id="contact">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          
          {/* Text Left */}
          <div>
            <h2 className="text-h3-bold mb-6">Mulai Proyek Impian Anda Bersama Kami</h2>
            <p className="text-body-lg-regular text-neutral-400 mb-10">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-primary-900/50 rounded-full flex items-center justify-center text-primary-400">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                </div>
                <div>
                  <h4 className="text-body-md-bold">Telepon</h4>
                  <p className="text-neutral-400">021-12345678</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-primary-900/50 rounded-full flex items-center justify-center text-primary-400">
                ...
                <div>
                  <h4 className="text-body-md-bold">Email</h4>
                  <p className="text-neutral-400">hello@archstudio.com</p>
                </div>
              </div>
            </div>
          </div>
